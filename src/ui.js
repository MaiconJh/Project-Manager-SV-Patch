// @context: export-preset-file save-dialog open-dialog apply-rehydrate feedback ui-diagnostics preset-ui-fix safe-bind tree-scroll-preserve.
/*
PM-SV-PATCH META
...
function _buildFileRow(r, snapshot) {
  ...
  row.dataset.absPath = _normalizeAbsPath(r.absPath);
